...
from models.transformer_geometry import TransformerEncoderLayer_CMA
...
class CMA_fusion(nn.Module):
    ...
    def forward(self, geometry_img, geometry_pc):
        ...
        ) = self.global_local_encoder(geometry_img, geometry_pc)
