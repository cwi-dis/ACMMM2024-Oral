...
class CMA_fusion(nn.Module):
    ...
    def forward(self, texture_img, geometry_img, texture_pc, geometry_pc):
        ...
        output_global = torch.stack(  # xm: stack the tensors in a new dimension
            (
                tex_img_global,
                geometry_img_global, # changed the order of the geometry_img_global and tex_pc_global
                tex_pc_global,
                geometry_pc_global,
                tex2D_geo2D_global_attention,
                geo2D_tex2D_global_attention,
        ...
        return output, output_local, output_global, tex_img_global, tex_pc_global, geometry_img_global, geometry_pc_global, tex2D_geo2D_attention, tex2D_geo2D_global_attention, geo2D_tex2D_attention, geo2D_tex2D_global_attention,tex3D_geo3D_attention, tex3D_geo3D_global_attention, geo3D_tex3D_attention, geo3D_tex3D_global_attention,tex2D_tex3D_attention,tex2D_tex3D_global_attention,  tex3D_tex2D_attention, tex3D_tex2D_global_attention, tex2D_geo3D_attention, tex2D_geo3D_global_attention,geo3D_tex2D_attention,geo3D_tex2D_global_attention,geo2D_tex3D_attention, geo2D_tex3D_global_attention, tex3D_geo2D_attention, tex3D_geo2D_global_attention, geo2D_geo3D_attention, geo2D_geo3D_global_attention, geo3D_geo2D_attention, geo3D_geo2D_global_attention
...
class MM_PCQAnet(nn.Module):
    ...
    def forward(
        ...
        (fusion_output_local_global, output_local, output_global, tex_img_global, tex_pc_global, geometry_img_global, geometry_pc_global, tex2D_geo2D_attention, tex2D_geo2D_global_attention, geo2D_tex2D_attention, geo2D_tex2D_global_attention,tex3D_geo3D_attention, tex3D_geo3D_global_attention, geo3D_tex3D_attention, geo3D_tex3D_global_attention,tex2D_tex3D_attention,tex2D_tex3D_global_attention,  tex3D_tex2D_attention, tex3D_tex2D_global_attention, tex2D_geo3D_attention, tex2D_geo3D_global_attention,geo3D_tex2D_attention,geo3D_tex2D_global_attention,geo2D_tex3D_attention, geo2D_tex3D_global_attention, tex3D_geo2D_attention, tex3D_geo2D_global_attention, geo2D_geo3D_attention, geo2D_geo3D_global_attention, geo3D_geo2D_attention, geo3D_geo2D_global_attention)= self.SharedFusion(
            texture_img,
            geometry_img,
            texture_pc,
            geometry_pc,
        ...
        return output_regression, output_classification, fusion_output_local_global, output_local, output_global, tex_img_global, tex_pc_global, geometry_img_global, geometry_pc_global, tex2D_geo2D_attention, tex2D_geo2D_global_attention, geo2D_tex2D_attention, geo2D_tex2D_global_attention,tex3D_geo3D_attention, tex3D_geo3D_global_attention, geo3D_tex3D_attention, geo3D_tex3D_global_attention,tex2D_tex3D_attention,tex2D_tex3D_global_attention,  tex3D_tex2D_attention, tex3D_tex2D_global_attention, tex2D_geo3D_attention, tex2D_geo3D_global_attention,geo3D_tex2D_attention,geo3D_tex2D_global_attention,geo2D_tex3D_attention, geo2D_tex3D_global_attention, tex3D_geo2D_attention, tex3D_geo2D_global_attention, geo2D_geo3D_attention, geo2D_geo3D_global_attention, geo3D_geo2D_attention, geo3D_geo2D_global_attention
