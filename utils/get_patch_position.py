...
def main(config):
    ...
    with open(save_name,'w') as f:
        ...
        f.close()
    print('Total consuming seconds /s :' + str(total_end-total_start))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_path', type=str, default = '/LSPCQA/lspcqa_patch_2048_position/') # path to the output patches
    parser.add_argument('--dataset', type=str, default = 'LSPCQA') # path to the output patches
    parser.add_argument('--modality', type=str, default = '3D_position') # path to the output patches
